...
import { CrossProjectReferenceLogItemComponent } from './cross-project-reference-log-item/cross-project-reference-log-item.component';
...
@NgModule({
  declarations: [
    CrossProjectReferenceLogItemComponent,
