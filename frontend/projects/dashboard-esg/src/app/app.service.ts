...
export type ViewerOrganizationAddress = {
...
export const formatAddress = (address: ViewerOrganizationAddress): string => [
    address.addressCountry,
    address.addressRegion === address.addressCountry ? undefined : address.addressRegion,
    (address.addressLocality === address.addressCountry) || (address.addressLocality === address.addressRegion)
      ? undefined
